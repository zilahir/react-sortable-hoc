...
| disableAnimation                  | Boolean                                                   | `false`                                                                                                                                                                  | Disable elements animation while element is being dragged                                                                                                                                                                                                                                                                                                                                                                                                              |
...
| useWindowAsAutoScrollerContainer  | Boolean                                                   | `false`                                                                                                                                                                  | If you want, you can set the `window` only as the auto scroller container (when useWindowAsScrollContainer set to `true` `window` uses for animation calculates too                                                                                                                                                                                                                                                                                                    |
